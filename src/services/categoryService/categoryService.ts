...
export default class CategoryService {
    ...
    async getCategoryList(searchQuery, categoryName, sortField, sortOrder, pageNumber, pageSize) {
        ...
        const data = await this.categoryRepository.getCategoryList(searchQueryOrDefault, categoryNameOrDefault, sortFieldOrDefault, sortOrderOrDefault, pageNumberOrDefault, pageSizeOrDefault);
        return data;
    }
