...
import { BookRepository } from "./bookRepository/bookRepository";
import PaginationRepository from "./paginationRepository/paginationRepository";

export {PaginationRepository}
